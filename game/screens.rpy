...
screen navigation():
    ...
    vbox:
        ...
        xpos If(renpy.get_screen("main_menu"), 0.47, gui.navigation_xpos)
        yalign 0.5
...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            label "[config.name!t]"
            text _("Благодарим вас за игру в техническую демо-версию")
            text _("Разработчики:")
            ...
            text _("Vuzi Dale - босс")
            text _("Jakum - видеомоушн продашкн, спецэффекты, оператор")
            text _("Three Young - конченный урод")
